...
export default function Navbar() {
  ...
  const handleThemeToggle = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    // Переключаем тему когда оверлей закрыл экран (под ним не видно)
